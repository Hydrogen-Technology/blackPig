...
func (c *userServiceClient) UpdateUser(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*UserReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserReply)
...
func (UnimplementedUserServiceServer) UpdateUser(context.Context, *RegisterRequest) (*UserReply, error) {
...
func _UserService_UpdateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UpdateUser(ctx, req.(*RegisterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
