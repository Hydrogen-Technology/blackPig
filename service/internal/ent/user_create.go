...
func (uc *UserCreate) SetCarPictures(s []string) *UserCreate {
	uc.mutation.SetCarPictures(s)
	return uc
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.CarPictures(); !ok {
		return &ValidationError{Name: "carPictures", err: errors.New(`ent: missing required field "User.carPictures"`)}
	}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.CarPictures(); ok {
		_spec.SetField(user.FieldCarPictures, field.TypeJSON, value)
		_node.CarPictures = value
	}
